...
public class Messages {
  ...
  public static final class CreateMessage {
    ...
    private @Nullable boolean enableCaching;

    public @Nullable boolean getEnableCaching() {
      return enableCaching;
    }

    public void setEnableCaching(@Nullable boolean setterArg) {
      this.enableCaching = setterArg;
    }
    ...
    public void setCacheKey(@Nullable String setterArg) {
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setEnableCaching(@NonNull boolean setterArg) {
        this.enableCaching = setterArg;
        return this;
      }
      ...
      public @NonNull CreateMessage build() {
        ...
        pigeonReturn.setMaxSingleFileCacheSize(maxSingleFileCacheSize);
        pigeonReturn.setMaxTotalCacheSize(maxTotalCacheSize);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(maxSingleFileCacheSize);
      toListResult.add(maxTotalCacheSize);
      return toListResult;
    }
