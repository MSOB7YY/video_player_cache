...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  VideoPlayerController.asset(
    ...
    this.bufferOptions,
        ...
        cacheDirectory = null,
        cacheKey = null,
        maxSingleFileCacheSize = _kDefaultMaxSingleFileCacheSize,
        maxTotalCacheSize = _kDefaultMaxTotalCacheSize,
  ...
  VideoPlayerController.network(
    ...
    this.cacheDirectory,
    this.cacheKey,
    this.maxSingleFileCacheSize = _kDefaultMaxSingleFileCacheSize,
    this.maxTotalCacheSize = _kDefaultMaxTotalCacheSize,
  })  : _closedCaptionFileFuture = closedCaptionFile,
  ...
  /// **Android Only**:
  /// Max Cache Size for a single file in bytes.
  ///
